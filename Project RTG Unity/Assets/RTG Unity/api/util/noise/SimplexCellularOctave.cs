namespace rtg.api.util.noise
{
    ...
    public class SimplexCellularOctave : CellOctave
    {
        ...
        private bool tooClose(double thisX, double thisY)
        {
            bool tooClose = false;
        ...
        public static void resetResultArray(NoiseInstance2[] instances, double[] results)
        {
            foreach (NoiseInstance2 instance in instances)
            {
                ...
                {
                    results[instance.f1Index] = double.PositiveInfinity;
                }
                if (instance.f2Index >= 0)
                {
                    results[instance.f2Index] = double.PositiveInfinity;
                }
            }
        }
        ...
        //2D Points: Dodecagon
        private static readonly double[] JITTER_2D = new double[] {
                         0,      0.408248290463863,
