namespace generic.init
{
    public class Biomes
    {
        ...
        public static world.biome.Biome HELL = new world.biome.Biome(8, world.biome.Biome.Type.HOT, world.biome.Biome.Type.DRY, world.biome.Biome.Type.HELL);
        ...
        public static world.biome.Biome ICE_MOUNTAINS = new world.biome.Biome(13, world.biome.Biome.Type.COLD, world.biome.Biome.Type.SNOWY, world.biome.Biome.Type.MOUNTAIN);
        ...
        public static world.biome.Biome DESERT_HILLS = new world.biome.Biome(17, world.biome.Biome.Type.HOT, world.biome.Biome.Type.DRY, world.biome.Biome.Type.SANDY, world.biome.Biome.Type.HILLS);
        public static world.biome.Biome FOREST_HILLS = new world.biome.Biome(18, world.biome.Biome.Type.FOREST, world.biome.Biome.Type.HILLS);
        public static world.biome.Biome TAIGA_HILLS = new world.biome.Biome(19, world.biome.Biome.Type.COLD, world.biome.Biome.Type.CONIFEROUS, world.biome.Biome.Type.FOREST, world.biome.Biome.Type.HILLS);
        ...
        public static world.biome.Biome JUNGLE_HILLS = new world.biome.Biome(22, world.biome.Biome.Type.HOT, world.biome.Biome.Type.WET, world.biome.Biome.Type.DENSE, world.biome.Biome.Type.JUNGLE, world.biome.Biome.Type.HILLS);
        ...
        public static world.biome.Biome BIRCH_FOREST_HILLS = new world.biome.Biome(28, world.biome.Biome.Type.FOREST, world.biome.Biome.Type.HILLS);
        ...
        public static world.biome.Biome TAIGA_COLD_HILLS = new world.biome.Biome(31, world.biome.Biome.Type.COLD, world.biome.Biome.Type.CONIFEROUS, world.biome.Biome.Type.FOREST, world.biome.Biome.Type.SNOWY, world.biome.Biome.Type.HILLS);
        ...
        public static world.biome.Biome REDWOOD_TAIGA_HILLS = new world.biome.Biome(33, world.biome.Biome.Type.COLD, world.biome.Biome.Type.CONIFEROUS, world.biome.Biome.Type.FOREST, world.biome.Biome.Type.HILLS);
        public static world.biome.Biome EXTREME_HILLS_WITH_TREES = new world.biome.Biome(34, world.biome.Biome.Type.MOUNTAIN, world.biome.Biome.Type.FOREST, world.biome.Biome.Type.SPARSE);
        ...
        public static world.biome.Biome SAVANNA_ROCK = new world.biome.Biome(36, world.biome.Biome.Type.HOT, world.biome.Biome.Type.SAVANNA, world.biome.Biome.Type.PLAINS, world.biome.Biome.Type.SPARSE);
        ...
        public static world.biome.Biome MESA_CLEAR_ROCK = new world.biome.Biome(39, world.biome.Biome.Type.MESA, world.biome.Biome.Type.SANDY);
