namespace rtg.world.biome.realistic.vanilla
{
    ...
    public class RealisticBiomeVanillaBirchForest : RealisticBiomeVanillaBase
    {

        public static Biome biome = Biomes.BIRCH_FOREST;
        public static Biome river = Biomes.RIVER;

        public RealisticBiomeVanillaBirchForest() : base(biome, river)
        {
        ...
        public class TerrainVanillaBirchForest : TerrainBase
        {
        ...
        public class SurfaceVanillaBirchForest : SurfaceBase
        {
            ...
            public SurfaceVanillaBirchForest(BiomeConfig config, Pixel top, Pixel fill, float minCliff, float stoneCliff, float stoneHeight, float stoneStrength, float clayCliff, Pixel mix, float mixSize) : base(config, top, fill)
            {
