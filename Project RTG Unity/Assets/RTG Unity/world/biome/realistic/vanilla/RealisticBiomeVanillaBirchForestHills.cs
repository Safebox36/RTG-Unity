namespace rtg.world.biome.realistic.vanilla
{
    ...
    public class RealisticBiomeVanillaBirchForestHills : RealisticBiomeVanillaBase
    {

        public static Biome biome = Biomes.BIRCH_FOREST_HILLS;
        public static Biome river = Biomes.RIVER;

        public RealisticBiomeVanillaBirchForestHills() : base(biome, river)
        {
        ...
        public class TerrainVanillaBirchForestHills : TerrainBase
        {
        ...
        override public SurfaceBase initSurface()
        {
            ...
            return new SurfaceVanillaBirchForestHills(config, Pixels.GRASS, Pixels.DIRT, 0f, 1.5f, 60f, 65f, 1.5f, PixelUtil.getStateDirt(2), 0.10f);
        }

        public class SurfaceVanillaBirchForestHills : SurfaceBase
        {
            ...
            public SurfaceVanillaBirchForestHills(BiomeConfig config, Pixel top, Pixel fill, float minCliff, float stoneCliff, float stoneHeight, float stoneStrength, float clayCliff, Pixel mix, float mixSize) : base(config, top, fill)
            {
