namespace rtg.world.biome.realistic.vanilla
{
    ...
    public class RealisticBiomeVanillaExtremeHillsEdge : RealisticBiomeVanillaBase
    {

        public static Biome biome = Biomes.SMALLER_EXTREME_HILLS;
        public static Biome river = Biomes.RIVER;

        public RealisticBiomeVanillaExtremeHillsEdge() : base(biome, river)
        {
        ...
        public class TerrainVanillaExtremeHillsEdge : TerrainBase
        {
        ...
        override public SurfaceBase initSurface()
        {
            ...
            return new SurfaceVanillaExtremeHillsEdge(config, biome.topPixel, biome.fillerPixel, Pixels.GRASS, Pixels.DIRT, 60f, -0.14f, 14f, 0.25f);
        }

        public class SurfaceVanillaExtremeHillsEdge : SurfaceBase
        {
            ...
            public SurfaceVanillaExtremeHillsEdge(BiomeConfig config, Pixel top, Pixel filler, Pixel mixTop, Pixel mixFill, float mixWidth, float mixHeight, float smallWidth, float smallStrength) : base(config, top, filler)
            {
