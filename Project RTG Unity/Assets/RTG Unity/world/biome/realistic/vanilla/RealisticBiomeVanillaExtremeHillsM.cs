namespace rtg.world.biome.realistic.vanilla
{
    ...
    public class RealisticBiomeVanillaExtremeHillsM : RealisticBiomeVanillaBase
    {

        public static Biome biome = Biomes.MUTATED_EXTREME_HILLS;
        public static Biome river = Biomes.RIVER;

        public RealisticBiomeVanillaExtremeHillsM() : base(biome, river)
        {
        ...
        public class TerrainVanillaExtremeHillsM : TerrainBase
        {
        ...
        override public SurfaceBase initSurface()
        {
            ...
            return new SurfaceVanillaExtremeHillsM(config, biome.topPixel, biome.fillerPixel, Pixels.GRASS, Pixels.DIRT, 60f, -0.14f, 14f, 0.25f);
        }

        public class SurfaceVanillaExtremeHillsM : SurfaceBase
        {
            ...
            public SurfaceVanillaExtremeHillsM(BiomeConfig config, Pixel top, Pixel filler, Pixel mixTop, Pixel mixFill, float mixWidth, float mixHeight, float smallWidth, float smallStrength) : base(config, top, filler)
            {
