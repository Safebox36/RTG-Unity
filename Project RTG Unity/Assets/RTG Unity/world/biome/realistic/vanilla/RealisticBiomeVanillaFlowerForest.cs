namespace rtg.world.biome.realistic.vanilla
{
    ...
    public class RealisticBiomeVanillaFlowerForest : RealisticBiomeVanillaBase
    {

        public static Biome biome = Biomes.MUTATED_FOREST;
        public static Biome river = Biomes.RIVER;

        public RealisticBiomeVanillaFlowerForest() : base(biome, river)
        {
        ...
        public class TerrainVanillaFlowerForest : TerrainBase
        {
        ...
        override public SurfaceBase initSurface()
        {
            ...
            return new SurfaceVanillaFlowerForest(config, Pixels.GRASS, Pixels.DIRT, 0f, 1.5f, 60f, 65f, 1.5f, Pixels.GRASS, 0.05f);
        }

        public class SurfaceVanillaFlowerForest : SurfaceBase
        {
            ...
            public SurfaceVanillaFlowerForest(BiomeConfig config, Pixel top, Pixel fill, float minCliff, float stoneCliff, float stoneHeight, float stoneStrength, float clayCliff, Pixel mix, float mixSize) : base(config, top, fill)
            {
