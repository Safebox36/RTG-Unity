namespace rtg.world.biome.realistic.vanilla
{
    ...
    public class RealisticBiomeVanillaJungle : RealisticBiomeVanillaBase
    {

        public static Biome biome = Biomes.JUNGLE;
        public static Biome river = Biomes.RIVER;

        public RealisticBiomeVanillaJungle() : base(biome, river)
        {
        ...
        public class TerrainVanillaJungle : TerrainBase
        {
        ...
        override public SurfaceBase initSurface()
        {
            ...
            return new SurfaceVanillaJungle(config, Pixels.GRASS, Pixels.DIRT, 0f, 1.5f, 60f, 65f, 1.5f, PixelUtil.getStateDirt(2), 0.09f);
        }

        public class SurfaceVanillaJungle : SurfaceBase
        {
            ...
            public SurfaceVanillaJungle(BiomeConfig config, Pixel top, Pixel fill, float minCliff, float stoneCliff, float stoneHeight, float stoneStrength, float clayCliff, Pixel mix, float mixSize) : base(config, top, fill)
            {
