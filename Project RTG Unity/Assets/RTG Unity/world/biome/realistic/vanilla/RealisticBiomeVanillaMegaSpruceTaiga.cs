namespace rtg.world.biome.realistic.vanilla
{
    ...
    public class RealisticBiomeVanillaMegaSpruceTaiga : RealisticBiomeVanillaBase
    {

        public static Biome biome = Biomes.MUTATED_REDWOOD_TAIGA;
        public static Biome river = Biomes.RIVER;

        public RealisticBiomeVanillaMegaSpruceTaiga() : base(biome, river)
        {
        ...
        public class TerrainVanillaMegaSpruceTaiga : TerrainBase
        {
        ...
        override public SurfaceBase initSurface()
        {
            ...
            return new SurfaceVanillaMegaSpruceTaiga(config, biome.topPixel, biome.fillerPixel);
        }

        public class SurfaceVanillaMegaSpruceTaiga : SurfaceBase
        {

            public SurfaceVanillaMegaSpruceTaiga(BiomeConfig config, Pixel top, Pixel fill) : base(config, top, fill)
            {
