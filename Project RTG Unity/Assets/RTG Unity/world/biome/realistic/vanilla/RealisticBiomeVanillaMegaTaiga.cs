namespace rtg.world.biome.realistic.vanilla
{
    ...
    public class RealisticBiomeVanillaMegaTaiga : RealisticBiomeVanillaBase
    {

        public static Biome biome = Biomes.REDWOOD_TAIGA;
        public static Biome river = Biomes.RIVER;

        public RealisticBiomeVanillaMegaTaiga() : base(biome, river)
        {
        ...
        public class TerrainVanillaMegaTaiga : TerrainBase
        {
        ...
        override public SurfaceBase initSurface()
        {
            ...
            return new SurfaceVanillaMegaTaiga(config, biome.topPixel, biome.fillerPixel);
        }

        public class SurfaceVanillaMegaTaiga : SurfaceBase
        {

            public SurfaceVanillaMegaTaiga(BiomeConfig config, Pixel top, Pixel fill) : base(config, top, fill)
            {
