namespace rtg.world.biome.realistic.vanilla
{
    ...
    public class RealisticBiomeVanillaMegaTaigaHills : RealisticBiomeVanillaBase
    {

        public static Biome biome = Biomes.REDWOOD_TAIGA_HILLS;
        public static Biome river = Biomes.RIVER;

        public RealisticBiomeVanillaMegaTaigaHills() : base(biome, river)
        {
        ...
        override public void initConfig()
        {
            ...
            this.getConfig().VOLCANO_CHANCE = -1;
        }
        ...
        public class TerrainVanillaMegaTaigaHills : TerrainBase
        {
        ...
        override public SurfaceBase initSurface()
        {
            ...
            return new SurfaceVanillaMegaTaigaHills(config, Pixels.GRASS, Pixels.DIRT, 0.2f);
        }

        public class SurfaceVanillaMegaTaigaHills : SurfaceBase
        {
            ...
            public SurfaceVanillaMegaTaigaHills(BiomeConfig config, Pixel top, Pixel fill, float minCliff) : base(config, top, fill)
            {

                min = minCliff;
            }

            public SurfaceVanillaMegaTaigaHills(BiomeConfig config, Pixel top, Pixel fill, float minCliff, float stoneCliff, float stoneHeight, float stoneStrength, float snowCliff, float snowHeight, float snowStrength, float clayCliff) : this(config, top, fill, minCliff)
            {
