namespace rtg.world.biome.realistic.vanilla
{
    ...
    public class RealisticBiomeVanillaMesaPlateau : RealisticBiomeVanillaBase
    {

        public static Biome biome = Biomes.MESA_CLEAR_ROCK;
        public static Biome river = Biomes.RIVER;

        public RealisticBiomeVanillaMesaPlateau() : base(biome, river)
        {
        ...
        public class TerrainVanillaMesaPlateau : TerrainBase
        {
             ...
             *
             */
            public TerrainVanillaMesaPlateau(bool riverGen, float heightStrength, float canyonWidth, float canyonHeight, float canyonStrength, float baseHeight)
            {
        ...
        override public SurfaceBase initSurface()
        {
            ...
            return new SurfaceVanillaMesaPlateau(config, PixelUtil.getStateSand(1), PixelUtil.getStateClay(1), 0);
        }
        ...
        public class SurfaceVanillaMesaPlateau : SurfaceBase
        {
            private int grassRaise = 0;

            public SurfaceVanillaMesaPlateau(BiomeConfig config, Pixel top, Pixel fill, int grassHeight) : base(config, top, fill)
            {
