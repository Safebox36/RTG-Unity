namespace rtg.world.biome.realistic.vanilla
{
    ...
    public class RealisticBiomeVanillaMesaPlateauM : RealisticBiomeVanillaBase
    {

        public static Biome biome = Biomes.MUTATED_MESA_CLEAR_ROCK;
        public static Biome river = Biomes.RIVER;

        public RealisticBiomeVanillaMesaPlateauM() : base(biome, river)
        {
        ...
        public class TerrainVanillaMesaPlateauM : TerrainBase
        {
             ...
             *
             */
            public TerrainVanillaMesaPlateauM(bool riverGen, float heightStrength, float canyonWidth, float canyonHeight, float canyonStrength, float baseHeight)
            {
                /**
        ...
        public class SurfaceVanillaMesaPlateauM : SurfaceBase
        {

            private int grassRaise = 0;

            public SurfaceVanillaMesaPlateauM(BiomeConfig config, Pixel top, Pixel fill, int grassHeight) : base(config, top, fill)
            {
