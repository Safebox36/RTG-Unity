namespace rtg.world.biome.realistic.vanilla
{
    ...
    public class RealisticBiomeVanillaRedwoodTaigaHills : RealisticBiomeVanillaBase
    {

        public static Biome biome = Biomes.MUTATED_REDWOOD_TAIGA_HILLS;
        public static Biome river = Biomes.RIVER;

        public RealisticBiomeVanillaRedwoodTaigaHills() : base(biome, river)
        {
        ...
        public class TerrainVanillaRedwoodTaigaHills : TerrainBase
        {
        ...
        override public SurfaceBase initSurface()
        {
            ...
            return new SurfaceVanillaRedwoodTaigaHills(config, Pixels.GRASS, Pixels.DIRT, 0.2f);
        }

        public class SurfaceVanillaRedwoodTaigaHills : SurfaceBase
        {
            ...
            public SurfaceVanillaRedwoodTaigaHills(BiomeConfig config, Pixel top, Pixel fill, float minCliff) : base(config, top, fill)
            {
