namespace rtg.world.biome.realistic.vanilla
{
    ...
    public class RealisticBiomeVanillaTaiga : RealisticBiomeVanillaBase
    {

        public static Biome biome = Biomes.TAIGA;
        public static Biome river = Biomes.RIVER;

        public RealisticBiomeVanillaTaiga() : base(biome, river)
        {
        ...
        public class TerrainVanillaTaiga : TerrainBase
        {
        ...
        override public SurfaceBase initSurface()
        {
            ...
            return new SurfaceVanillaTaiga(config, biome.topPixel, biome.fillerPixel);
        }

        public class SurfaceVanillaTaiga : SurfaceBase
        {
