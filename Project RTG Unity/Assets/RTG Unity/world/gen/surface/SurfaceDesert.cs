namespace rtg.world.gen.surface
{
    ...
    public class SurfaceDesert : SurfaceBase
    {
        ...
        public SurfaceDesert(BiomeConfig config, IBlockState top, IBlockState filler, IBlockState bottom, IBlockState cliff1, IBlockState cliff2) : base(config, top, filler)
        {
            bottomBlock = bottom;
            cliffBlock1 = cliff1;
            cliffBlock2 = cliff2;
