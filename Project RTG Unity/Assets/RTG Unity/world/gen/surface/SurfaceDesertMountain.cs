namespace rtg.world.gen.surface
{
    ...
    public class SurfaceDesertMountain : SurfaceBase
    {
        ...
        public SurfaceDesertMountain(BiomeConfig config, IPixelState top, IPixelState fill, float minCliff) : base(config, top, fill)
        {
            min = minCliff;
        }

        public SurfaceDesertMountain(BiomeConfig config, IPixelState top, IPixelState fill, float minCliff, float stoneCliff, float stoneHeight, float stoneStrength, float clayCliff) : this(config, top, fill, minCliff)
        {
            sCliff = stoneCliff;
            sHeight = stoneHeight;
