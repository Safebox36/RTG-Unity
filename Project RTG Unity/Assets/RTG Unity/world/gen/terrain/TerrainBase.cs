namespace rtg.world.gen.terrain
{
    ...
    public abstract class TerrainBase
    {
        ...
        public TerrainBase() : this(68f)// default to marginally above sea level;
        {
        ...
        public static float terrainPolar(int x, int y, OpenSimplexNoise simplex, float river)
        {
            ...
            float st = (simplex.noise2(x / 160f, y / 160f) + 0.38f) * (minimumDuneHeight + configRTG.DUNE_HEIGHT) * river;
            st = st < 0.2f ? 0.2f : st;
