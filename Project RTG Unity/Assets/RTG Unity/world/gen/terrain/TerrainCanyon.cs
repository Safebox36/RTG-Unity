namespace rtg.world.gen.terrain
{
    ...
    public class TerrainCanyon : TerrainBase
    {
         ...
         *
         */
        public TerrainCanyon(bool riverGen, float heightStrength, float canyonWidth, float canyonHeight, float canyonStrength, float baseHeight)
        {
